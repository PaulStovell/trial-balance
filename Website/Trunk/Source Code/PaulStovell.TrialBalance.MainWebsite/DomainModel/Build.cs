...
namespace PaulStovell.TrialBalance.MainWebsite.DomainModel {
    public class Build {
        ...
        public string DownloadLink {
            get {
                return "/GetBuild.aspx?" + GetBuild.BUILD_NUMBER_QUERY_STRING_KEY + "=" + this.BuildNumber;
            }
        }

        public string EditLink {
            get {
                return "/Administration/EditBuild.aspx?" + EditBuild.BUILD_NUMBER_QUERY_STRING_KEY + "=" + this.BuildNumber;
            }
        }
